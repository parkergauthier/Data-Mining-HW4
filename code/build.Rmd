...
```{r message=FALSE, warning=FALSE, echo=FALSE}
rules_frame %>% head(10) %>% kable(caption = "Rules Arranged in Descending Order by Lift")
```
...
rules_frame %>% head(10) %>% kable(caption = "Rules Arranged in Descending Order by Confidence")
