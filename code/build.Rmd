...
```{r include= FALSE}
groceries = read.csv(here("data/groceries.csv"), header = FALSE)

groceries$shopper = 1:nrow(groceries)

groceries = split(x = groceries$V1 & groceries$V2, f = groceries$shopper)
